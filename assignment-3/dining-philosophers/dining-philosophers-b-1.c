...
void* eat1(void* args) {
  ...
  printf("Philosopher 1 started eating using bowl1\n");
  sleep(1);
  printf("Philosopher 1 finished eating using bowl1\n");
...
void* eat2(void* args) {
  ...
  printf("Philosopher 2 started eating using bowl1\n");
  sleep(1);
  printf("Philosopher 2 finished eating using bowl1\n");
...
void* eat3(void* args) {
  ...
  printf("Philosopher 3 started eating using bowl1\n");
  sleep(1);
  printf("Philosopher 3 finished eating using bowl1\n");
...
void* eat4(void* args) {
  ...
  printf("Philosopher 4 started eating using bowl2\n");
  sleep(1);
  printf("Philosopher 4 finished eating using bowl2\n");
...
void* eat5(void* args) {
  ...
  printf("Philosopher 5 started eating using bowl2\n");
  sleep(1);
  printf("Philosopher 5 finished eating using bowl2\n");
